...
import { Buttton, Gap, Input, Link, Textarea, Upload } from "../../components";
import "./creatingblog.scss";
  ...
  return (
    <div className="blog-post">
      ...
      <div className="button-action">
        <Buttton title={isUpdate ? 'Update' : 'Simpan'} onClick={onSubmit}/>
      </div>
      <Gap height={20} />
    </div>
  );
